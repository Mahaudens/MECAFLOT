...
\begin{center}
<<<<<<< HEAD
	\Large Universithé ou café de Nuton\\
	Faculté des Sciences Appliquées\\
=======
	\Large Université de Liège\\
	Faculté des Sciences Appliquées \\
>>>>>>> c8c1450b82cf07f0474bfc7d658bd336d4f5beea
	\vspace{0.5cm}
...
<<<<<<< HEAD
	...
	Test de citation selon YANN Dreze \cite{AbedonHymanThomas2003} et aussi\footnote{Test \cite{Nobody06}.} \cite{Abedon1994}.
=======
	Yann est le plus beau 
	BOOOOOOOOOOO
	Test de citation selon YANN Dreze  \cite{AbedonHymanThomas2003} et aussi\footnote{Test \cite{Nobody06}.} \cite{Abedon1994}.
>>>>>>> Branche
